...
<head>
    ...
    flex-direction: column;
        ...
        .edit-btn {
            background: linear-gradient(135deg, #0d6d00, #169705);
            color: white;
            border: none;
            padding: 12px 18px;
            font-size: 14px;
        ...
        .edit-btn:hover {
            background: linear-gradient(135deg, #128b02, #1cbf0b);
...
<body>
    ...
    <div class="content-container">
            ...
            <ul>
                <?php foreach ($announcements as $announcement): ?>
                    <li>
                        ...
                        <button class="edit-btn" onclick="editAnnouncement(<?php echo $announcement['id']; ?>)">Edit</button>
                    </li>
                <?php endforeach; ?>
            </ul>
        </div>
        ...
        <h1 class="librarian-title">Meet Our School Librarians</h1>
    ...
    const librarians = document.querySelector('.librarians');

    
    sidebar.classList.toggle('show');
    mainContent.classList.toggle('shift');
    librarians.classList.toggle('shift');  
}
...
document.addEventListener('click', function(event) {
    ...
    if (!sidebar.contains(event.target) && !toggleBtn.contains(event.target)) {
        ...
        librarians.classList.remove('shift');  
    }
});

        function editAnnouncement(id) {
    const newText = prompt("Edit Announcement:");
    if (newText !== null && newText.trim() !== "") {
        fetch(`php/update_announcement.php?id=${id}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
            },
            body: `announcement_text=${encodeURIComponent(newText)}`,
        })
